...
def medium_game(number):
    print("Great! You have selected the [dark_orange]Medium[/dark_orange] difficulty level.")
    ...
    for i in range(0,5):
        ...
        if intguess == number:
            ...
            print(f"Your current high score in Medium Mode is {min_score}")
            flag = 1
